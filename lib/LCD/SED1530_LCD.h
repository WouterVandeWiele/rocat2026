...
class SED1530_LCD : public GFXcanvas1, public DriverBase {
public:
  #if !defined(IO_EXPANDER)
    SED1530_LCD(SX1509& sx, const uint8_t A0, const uint8_t RW, const uint8_t EN, const uint8_t BACKLIGHT, const uint8_t POWER, const uint8_t *DATA);
